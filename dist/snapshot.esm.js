...
import { hexlify, arrayify, isHexString } from '@ethersproject/bytes';
...
function ipfsGet(gateway, ipfsHash, protocolType) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, fetch$1(url).then(function (res) { return res.json(); })];
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch$1(SNAPSHOT_SCORE_API, {
                            method: 'POST',
...
var retrieveInfoFromOracle = function (provider, network, oracleAddress, questionId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                result = _a.sent();
                currentBond = BigNumber$1.from(result[1][0]);
                answer = BigNumber$1.from(result[2][0]);
                return [2 /*return*/, {
                        currentBond: currentBond,
                        isApproved: answer.eq(BigNumber$1.from(1)),
                        endTime: BigNumber$1.from(result[0][0]).toNumber()
                    }];
...
var Plugin$2 = /** @class */ (function () {
    ...
    Plugin.prototype.validateTransaction = function (transaction) {
        var addressEmptyOrValidate = transaction.to === '' || isAddress(transaction.to);
    ...
    Plugin.prototype.loadClaimBondData = function (web3, network, questionId, oracleAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        contract = new Contract(oracleAddress, OracleAbi, web3);
                        provider = getProvider(network);
                        return [4 /*yield*/, multicall(network, provider, OracleAbi, [
                    ...
                    case 7:
                        ...
                        alreadyClaimed = BigNumber$1.from(historyHash).eq(0);
                        ...
                        votedForCorrectQuestion = currentUserAnswers.some(function (answer) {
                            if (answer) {
                                return BigNumber$1.from(answer).eq(bestAnswer);
                            }
                        }) && isFinalized;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!BigNumber$1.from(currentHistoryHash).eq(0)) return [3 /*break*/, 4];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        currentBondIsZero = currentBond.eq(BigNumber$1.from(0));
                        if (currentBondIsZero) {
                            daoBondIsZero = BigNumber$1.from(minimumBondInDaoModule).eq(0);
                            bond = daoBondIsZero ? BigNumber$1.from(10) : minimumBondInDaoModule;
                        }
                        else {
